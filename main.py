...
# === STREAMLIT UI ===
st.title("✨ Magic AI Lyrics Generator 🌈")
...
voice = st.selectbox("🗣️ Vocal Style", ["Male", "Female", "Child", "Robotic", "Soulful", "Rap", "Whisper"])

if st.button("🎤 Generate Magical Lyrics"):
    with st.spinner("🪄 Crafting lyrics with a touch of magic..."):
        prompt = f"Write a {genre} song titled '{title}' with a {mood} mood and {bpm} BPM. Include a chorus and meaningful verses. The voice style should feel {voice.lower()}."
